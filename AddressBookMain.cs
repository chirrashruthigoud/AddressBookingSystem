...
namespace AddressBookSystem
{
    public class AddressBookMain
    {
            ...
            switch (choice)
            {
                case 1:
                    ...
                    foreach (var pair in dictionarybook.Keys)
                    {
                        ...
                        foreach (Contact data in Person.FindAll(s => s.city.ToLower() == cityName.ToLower()).ToList())
                        {
                            Console.WriteLine("\nFirstName: " + data.firstName + " " +
                                "\nLastName: " + data.lastName + " " +
                                "\nZipcode: " + data.zipcode + " " +
                ...
                case 2:
                    ...
                    foreach (var pair in dictionarybook.Keys)
                    {
                        Console.WriteLine("Address Book Name: " + pair);
                        Console.WriteLine("The Contact Details of {0} are:\n--------------------------", stateName);
                        foreach (Contact data in Person.FindAll(s => s.state.ToLower() == stateName.ToLower()).ToList())
                        {
                            Console.WriteLine("\nFirstName: " + data.firstName + " " +
                                "\nLastName: " + data.lastName + " " +
                                "\nZipcode: " + data.zipcode + " " +
        ...
        public static void ReadWritePersonContactsByUsingFileIO()
        {
            //Write in  file
            Console.Clear();
            string filePath = @"C:\Users\Admin\source\repos\214\AddressBookingSystem\AddressBookingSystem\PersonalDetails.txt";
